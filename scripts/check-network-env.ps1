...
Write-Host "2) Set NODE_EXTRA_CA_CERTS to corporate PEM chain before npm install." -ForegroundColor White
Write-Host "3) Optionally set npm cafile to the same PEM path." -ForegroundColor White
Write-Host "4) Configure proxy/https-proxy if your environment requires it." -ForegroundColor White
Write-Host "5) Run npm run repair:env then npm install." -ForegroundColor White
